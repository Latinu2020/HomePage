...
with col1:
    st.image(linux_pic_read, width=150)
with col2:
    st.image(unix1_pic_read, width=150)
with col3:
    st.image(unix2_pic_read, width=150)
with col4:
    st.image(unix3_pic_read, width=150)
with col5:
    st.image(windows_pic_read, width=150)    