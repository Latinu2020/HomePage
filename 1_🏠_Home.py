...
<h1 style="will-change: opacity; opacity: 0; position: absolute; border-radius: inherit; text-align: center; text-shadow: 2px 2px 5px red; font-family: Arial;">Welcome</h1>
"""
